...
(note that the following wget comment uses ubuntu2404 which points to a repository containing all the CUDA and CUDNN  libraries needed for RC Astro tools)
