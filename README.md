...
This guide enables GPU (CUDA) acceleration with Linux (Kubuntu and other Ubuntu versions).  Kubuntu is a Linux version which has a Windows like environment and is what PixInsight recommends. It now supports the ONNX runtime libraries which simplifies the install making the process much shorter and easier. It is updated to support Kubuntu 26.04 LTS.  It also supports Kubuntu 24.04 LTS. The old guide is at the end of these instructions under Archived Previous Instructions. 
...
**Install Nvidia CUDA repository for Kubuntu 26.04** (substitute ubuntu2404 in the following wget command if you are installing Kubuntu 24.04)
...
<br>
<br>
**Install CUDA 12.8 and CUDNN 9 libraries**<br>
<br>
...
**ARCHIVED PREVIOUS INSTRUCTIONS**
