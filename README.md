...
This guide enables GPU (CUDA) acceleration with Linux (Kubuntu and other Ubuntu versions).  Kubuntu is a Linux version which has a Windows like environment and is what PixInsight recommends. It now supports the ONNX runtime libraries which simplifies the install making the process much shorter and easier. It is updated to support Kubuntu 26.04 LTS.  It also supports Kubuntu 24.04 LTS. The old guide which supports Tensorflow libraries is at the end of these instructions under the section  "ARCHIVED INSTRUCTONS INCLUDING TENSORFLOW LIBRARY INSTALL"
...
select the 26.04 LTS - Plasma 6 version 64 bit download
...
(note.. if you are installing Kubuntu 24.04 change ubuntu2604 to ubuntu2404 in the following wget command)
...
sudo ldconfig<br>
<br>
if libcublas.so.12 or libcublasLt.so.12 list as not found enter<br><br>
sudo apt install libcublas-12-8<br>
sudo ldconfig<br>
<br>
if libcufft.so.11 lists as not found enter <br><br>
sudo apt install libcufft-12-8<br>
sudo ldconfig<br>
<br>
if libnvrtc.so.12 lists as not found enter <br><br>
sudo apt install cuda-nvrtc-12-8<br>
sudo ldconfig<br>
<br>
if libcudnn.so.9 lists as not found  enter <br><br>
...
Installing a newer version of PixInsight follows the same instructions as a new install since the installer automatically detects and uninstalls the prevous version. 
...
**ARCHIVED  INSTRUCTIONS INCLUDING TENSORFLOW LIBRARY INSTALL**
